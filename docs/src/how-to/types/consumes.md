...
See [Target Cloudflare Workers](../projects/cloudflare-workers.md) for the
target details.

## Related

- Reference: [type system](../../reference/types.md).
- Explanation: [How a Karn program is shaped](../../explanation/how-a-karn-program-is-shaped.md).
