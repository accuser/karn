...
> ⚠️ **Bynk is pre-1.0 (currently v0.101) and under active development.**
...
- **New to Bynk?** Begin with [What is Bynk?](introduction/what-is-bynk.md),
...
- **Evaluating Bynk?** Read [Why Bynk exists](about/why-bynk-exists.md),
  then [Bynk compared to TypeScript](about/bynk-compared-to-typescript.md).

> [!NOTE]
> Meet an unfamiliar term? The [glossary](reference/glossary.md) defines Bynk's
