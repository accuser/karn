...
adapter_body_item ::= binding_decl | uses_decl | consumes_decl | exports_decl | type_decl | fn_decl | capability_decl | provider_decl | service_decl | agent_decl
...
type_ref ::= base_type | unit_type | validation_error_type | generic_type_ref | identifier
unit_type ::= "(" ")"
validation_error_type ::= "ValidationError"
generic_type_ref ::= ("Result" | "Option" | "Effect" | "HttpResult") "[" type_ref ("," type_ref)* "]"
fn_decl ::= "fn" (method_name | identifier) "(" params? ")" "->" type_ref block
