...
We assume you have already [installed `bynkc`](../introduction/install.md). Check
...
[Tutorial 4](04-refined-types.md); for now, just note that Bynk types carry an
...
TypeScript? See [How a Bynk program is shaped](../guides/program-structure/how-a-program-is-shaped.md)
