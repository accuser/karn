...
- [Add an authorisation invariant](authorisation.md) — refinement actors and the `401`/`403` split.
- [Know which context called you](cross-context-callers.md) — the `Caller` identity.
