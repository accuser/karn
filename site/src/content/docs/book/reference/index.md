...
tasks see the [how-to guides](/book/guides/).
...
- [`bynk.toml` manifest](/book/reference/manifest/) — every manifest key.
- [Emission](/book/reference/emission/) — the TypeScript each construct emits.
...
- [CLI (`bynkc`)](/book/reference/cli/) — from the clap command tree.
