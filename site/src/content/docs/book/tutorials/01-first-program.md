---
title: Compile your first program
---
...
We assume you have already [installed `bynkc`](/book/introduction/install/). Check
...
> service is [`bynk new`](/book/guides/projects-build-and-deployment/start-a-project/):
...
That is a complete, valid Bynk program. `commons demo { … }` declares a module
...
Notice that one line of Bynk produced more than a bare type alias. `Id` is a
...
[Tutorial 4](/book/tutorials/04-refined-types/); for now, just note that Bynk types carry an
...
➡️ **[Tutorial 2: Build a small HTTP service](/book/tutorials/02-http-service/)**

---

*Want the bigger picture behind `commons`, branding, and compiling to
TypeScript? See [How a Bynk program is shaped](/book/guides/program-structure/how-a-program-is-shaped/)
and [Why compile to TypeScript](/book/guides/projects-build-and-deployment/why-compile-to-typescript/).*
