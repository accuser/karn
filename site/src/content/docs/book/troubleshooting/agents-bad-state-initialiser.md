---
title: "`bynk.agents.bad_state_initialiser`"
---
```text
...
- Reference: [Agents](/book/reference/agents/) — state initialisation.
- [Model an agent as a state machine](/book/guides/agents-and-state/state-machine/)
