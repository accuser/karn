---
title: "§7 Meaning by translation"
---
Bynk has no operational semantics. A program's **dynamic meaning is defined by
translation**: it is the behaviour of the TypeScript the compiler emits for it,
executed against the runtime library ([§7.4](/book/spec/runtime-library/)). This chapter
defines that translation per construct, and the two emission targets it varies
over.

## §7.1 The model

For every well-formed program ([§5](/book/spec/static-semantics/)) the compiler emits
...
is a defect ([§1.1](/book/spec/scope/)). The emitted output is deterministic and each file
is headed `// Generated by bynkc — do not edit by hand.`

## §7.2 Targets

A program is emitted for one of two targets, selected by `--target`
([§8](/book/spec/compilation-model/)). A `commons` emits the same plain TypeScript — types
...
field zeros and initialisers of [§5.4](/book/spec/static-semantics/#54-agents--state), and
...
compile-time contract. The handler `by` clause ([§5.7a](/book/spec/static-semantics/#57a-actors--the-by-clause-v045))
...
([§5.9](/book/spec/static-semantics/#59-testing-constructs)) lowers to a runtime check
...
unit's flattened consumes ([§5.8](/book/spec/static-semantics/#58-boundaries--cross-context)),
...
`--platform`, [§8.5](/book/spec/compilation-model/#85-the-platform-axis)). Because the
...
interface ([§7.4](/book/spec/runtime-library/)) carries the matching `list` page
...
on, defined in **[§7.4 The runtime library](/book/spec/runtime-library/)**.
