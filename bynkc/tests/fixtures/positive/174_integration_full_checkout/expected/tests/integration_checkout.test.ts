  ...
  try {
    ...
    void (((__d) => {
        switch (__d.tag) {
          case "Ok": {
            const n = __d.value;
            return __karnAssert((n === 2), "offset 557", 557, 563);
          }
          case "Err": {
            return __karnAssert((false), "offset 587", 587, 592);
          }
        }
    ...
    void (((__d) => {
        switch (__d.tag) {
          case "Err": {
            ...
            return __karnAssert((true), "offset 758", 758, 762);
          }
          default: {
            return __karnAssert((false), "offset 793", 793, 798);
          }
        }
        throw new Error("non-exhaustive match");
      })(r));
