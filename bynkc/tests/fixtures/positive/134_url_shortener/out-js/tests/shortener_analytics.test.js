...
function __karnAssertionFailure(location, start, end) {
    return new AssertionError(location, start, end);
}
function __karnAssert(cond, location, start, end) {
    if (!cond) {
        throw __karnAssertionFailure(location, start, end);
    }
}
...
async function test_short_code_rejects_too_short_input() {
    try {
        ...
        void (((__d) => {
            switch (__d.tag) {
                case "Ok": {
                    return __karnAssert((false), "offset 158", 158, 163);
                }
                case "Err": {
                    return __karnAssert((true), "offset 187", 187, 191);
                }
            }
...
async function test_short_code_accepts_valid_input() {
    try {
        ...
        void (((__d) => {
            switch (__d.tag) {
                case "Ok": {
                    return __karnAssert((true), "offset 334", 334, 338);
                }
                case "Err": {
                    return __karnAssert((false), "offset 362", 362, 367);
                }
            }
            throw new Error("non-exhaustive match");
        })(result));
...
async function test_long_url_accepts_a_typical_url() {
    try {
        ...
        if (!(result.tag === "Ok")) {
            throw __karnAssertionFailure("offset 496", 496, 511);
        }
        return { pass: true };
    }
    catch (e) {
