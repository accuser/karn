...
[![crates.io](https://img.shields.io/crates/v/karn-grammar.svg)](https://crates.io/crates/karn-grammar)
[![docs.rs](https://img.shields.io/docsrs/karn-grammar)](https://docs.rs/karn-grammar)
[![License: MIT OR Apache-2.0](https://img.shields.io/badge/license-MIT%20OR%20Apache--2.0-blue.svg)](#license)

Renders the [`tree-sitter-karn`](https://github.com/accuser/karn/tree/main/tree-sitter-karn)
grammar to **EBNF** for the [Karn](https://github.com/accuser/karn) language
reference.

This crate is the single source of the grammar reference. It takes the compiled
grammar JSON (`tree-sitter-karn/src/grammar.json`) as input and is otherwise
...
This is an internal build-time crate for the Karn project — it has no runtime
purpose in a Karn program. Its two consumers are:

- `karnc/tests/grammar_reference.rs` — generates the appendix page, blessed
  against the committed `docs/src/reference/grammar.md`.
- [`mdbook-karn-grammar`](https://github.com/accuser/karn/tree/main/mdbook-karn-grammar)
  — the `{{#grammar <rule>}}` include preprocessor for the book.

## Use

```rust
use karn_grammar::{render_appendix, render_rule};

let grammar_json = std::fs::read_to_string("tree-sitter-karn/src/grammar.json")?;
...
[API docs](https://docs.rs/karn-grammar).
