...
//!
//! `docs/src/reference/grammar.md` is rendered from the compiled grammar (via
//! the `karn-grammar` crate), so it cannot drift from the parser. Regenerate
//! after a grammar change with:
